...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<link href="https://fonts.googleapis.com/css?family=Abril+Fatface|Anton|Noto+Sans:400,700|Paytone+One|Permanent+Marker" rel="stylesheet">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="colorlib-navbar-brand">
							<a class="colorlib-logo" href="home"><img alt="" src="./resources/images/suriwhite.png" style="width: 40%;"> </a>
						</div>
			...
			<div class="container">
				<div class="row row-padded-bottom">
					<div class="col-md-7 animate-box">
						<img class="img-responsive" src="./resources/images/work-1.jpg" alt="work">
						<img class="img-responsive" src="./resources/images/work-2.jpg" alt="work">
						<img class="img-responsive" src="./resources/images/work-3.jpg" alt="work">
						<img class="img-responsive" src="./resources/images/work-4.jpg" alt="work">
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6 animate-box text-center">
						<a href="work-single.html" class="work-img" style="background-image: url(./resources/images/work-1.jpg);">
							<div class="overlay"></div>
							<div class="desc">
					...
					<div class="col-md-6 animate-box text-center">
						<a href="work-single.html" class="work-img" style="background-image: url(./resources/images/work-2.jpg);">
							<div class="overlay"></div>
							<div class="desc">
								<span class="icon"><i class="icon-heart-outline"></i></span>
